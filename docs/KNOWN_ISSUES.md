...
### KI-034 — The GitHub Actions Android release job has never worked

**Status:** Fix pushed 2026-09-09 (workflow rewritten: the Android job runs `tauri android build`, both desktop jobs get the Vosk library, and the workflow can be run by hand without a tag); awaiting a green run before this is closed  
